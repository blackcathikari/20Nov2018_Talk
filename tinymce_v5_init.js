...
const init = (specifics) => {
	return {
		...
		"image media| numlist bullist | charmap | code codesample | forecolor backcolor emoticons | fullpage | fullscreen | anchor | insertdatetime  pagebreak template searchreplace  toc tocupdate spellchecker help removeformat | cut copy paste | selectall remove | sidebarBtn",
		...specifics
	};
};